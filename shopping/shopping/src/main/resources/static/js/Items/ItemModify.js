...
{
    if(document.getElementById("image_checked"+id).value == "checked")
    {
        document.getElementById("image_checked"+id).value = "unchecked";
    }
    else if(document.getElementById("image_checked"+id).value == "unchecked")
    {
        document.getElementById("image_checked"+id).value = "checked";
    }
}

function image_view(value)
{
    var url = "/tools/download?image="+value;
